...
institute: Qualitymanagement and Methods
location: Toulouse
date: 'July 2019'
output: 
  slideSTAT::slideSTAT:
...
- [https://github.com/uRosConf/voronoiTreemap](https://github.com/uRosConf/voronoiTreemap)
- important functions:
...
```{r, echo = TRUE, fig.fullwidth=TRUE}
vt_d3(gdp_json,label = FALSE, color_border = "#000000",
      size_border = "2px", legend = TRUE)
```
